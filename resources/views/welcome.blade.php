    ...
    <body class="gradient-background">
        ...
        <div class="container mx-auto d-block">
            <div class="about mx-auto d-block col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <p class="skill text-center text-white"><i class="bi bi-houses"></i> Corretor de imóveis</p>
                <p class="skill text-center text-white">Texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto </p>
